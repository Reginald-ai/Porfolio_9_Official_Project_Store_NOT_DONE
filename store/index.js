const state = () => ({
  ...
  sources: [
    ...
    },
    {
      ...
      title: "Google Font",
      text:
        "If you're looking for some new fonts, this list of the best Google Fonts is a great place to start. All of the fonts listed here are open source",
      reviews: "65 Reviews",
      value: 4.5,
    ...
    },
    {
      ...
      text:
        "Download Avast Free Antivirus and protect your PC against viruses and malware. Our best antivirus to keep your PC secure and private.",
      reviews: "820 Reviews",
      value: 4.5,
    ...
    },
    {
      ...
      text:
        "In responsive design, a breakpoint is the “point” at which a website's content and design will adapt in a certain way.. ",
      reviews: "217 Reviews",
      value: 4.5,
      href:
    ...
    },
    {
      ...
      text:
        "The background-image property sets one or more background images for an element. By default, a background-image...",
      reviews: "417 Reviews",
      value: 4.5,
      href:
    ...
    },
    {
      ...
      title: "Box Model",
      text:
        "In CSS, the term 'box model' is used when talking about design and layout. The CSS box model is essentially a box that wraps around...",
      reviews: "187 Reviews",
      value: 4.5,
    ...
    },
    {
      ...
      title: "JS Loops",
      text:
        "Different Kinds of Loops · for - loops through a block of code a number of times · for/in - loops through the properties of an..",
      reviews: "172 Reviews",
      value: 4.5,
    ...
    },
    {
      ...
      text:
        "Javascript supports the nested loop in javascript. The loop can have one or more or simple can have any number of loops defined inside loop..",
      reviews: "17 Reviews",
      value: 4.5,
